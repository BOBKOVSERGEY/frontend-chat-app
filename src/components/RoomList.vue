...
import AddChatRoomDialog from 'components/AddChatRoomDialog.vue';
import UpdateChatRoomDialog from 'components/UpdateChatRoomDialog.vue';
...
const goToRoom = async (roomId: number) => {
  await router.push(`/rooms/${roomId}/messages`);
};
